    ...
    : AudioProcessorEditor (&p), audioProcessor (p)
{
    ...
    auto aspectRatio = 2.5;
    setResizeLimits(aspectRatio * 200, 200, aspectRatio * 1200, 1200);
    getConstrainer()->setFixedAspectRatio(aspectRatio);

    auto screenHeight = 400;
    setSize(aspectRatio * screenHeight, screenHeight);
    ...
    amountSlider.setRange(0.0f, 5.0f, 0.1f);
    amountSlider.addListener(this);
    amountSlider.setDoubleClickReturnValue(true, 0.0f);
    amountSlider.setSliderSnapsToMousePosition(true);
    ...
    lowGainSlider.setRange(0.0f, 24.0f, 0.1f);
    lowGainSlider.addListener(this);
    lowGainSlider.setDoubleClickReturnValue(true, 0.0f);
    lowGainSlider.setSliderSnapsToMousePosition(true);
    ...
    lmGainSlider.setRange(0.0f, 24.0f, 0.1f);
    lmGainSlider.addListener(this);
    lmGainSlider.setDoubleClickReturnValue(true, 0.0f);
    lmGainSlider.setSliderSnapsToMousePosition(true);
    ...
    hmGainSlider.setRange(0.0f, 24.0f, 0.1f);
    hmGainSlider.addListener(this);
    hmGainSlider.setDoubleClickReturnValue(true, 0.0f);
    hmGainSlider.setSliderSnapsToMousePosition(true);
    ...
    highGainSlider.setRange(0.0f, 24.0f, 0.1f);
    highGainSlider.addListener(this);
    highGainSlider.setDoubleClickReturnValue(true, 0.0f);
    highGainSlider.setSliderSnapsToMousePosition(true);
    ...
    lowFreqSlider.setSliderSnapsToMousePosition(true);
    ...
    lmFreqSilder.addListener(this);
    lmFreqSilder.setDoubleClickReturnValue(true, 150);
    lmFreqSilder.setSliderSnapsToMousePosition(true);
    ...
    hmFreqSlider.addListener(this);
    hmFreqSlider.setDoubleClickReturnValue(true, 4000);
    hmFreqSlider.setSliderSnapsToMousePosition(true);
    ...
    highFreqSlider.setSliderSnapsToMousePosition(true);
    ...
    outputSlider.setRange(-24.0f, 12.0f, 0.1f);
    ...
    attackSlider.setRange(1.0f, 150.0f, 0.0f);
    ...
    releaseSlider.setRange(5.0f, 350.0f, 0.0f);
...
void SpikeQAudioProcessorEditor::resized()
{
    ...
    x2Button.setBounds(amountSlider.getX() + (amountSlider.getWidth() * 0.5) - (sliderHeight * 0.4), amountSlider.getBottom() + (sliderSpacing * 0.5), sliderHeight * 0.75, sliderHeight * 0.75);
    clipButton.setBounds(x2Button.getX() - sliderHeight, highFreqSlider.getY(), sliderHeight * 0.75, sliderHeight * 0.75);
    osButton.setBounds(x2Button.getX() + sliderHeight, highFreqSlider.getY(), sliderHeight * 0.75, sliderHeight * 0.75);
}
