...
//==============================================================================
SpikeQAudioProcessorEditor::SpikeQAudioProcessorEditor (SpikeQAudioProcessor& p)
    : AudioProcessorEditor (&p), audioProcessor (p)
{
    ...
    amountSliderValue = std::make_unique <AudioProcessorValueTreeState::SliderAttachment>(audioProcessor.parameters, AMOUNT_ID, amountSlider);
    lowFreqSliderValue = std::make_unique <AudioProcessorValueTreeState::SliderAttachment>(audioProcessor.parameters, LSF_ID, lowFreqSlider);
    lowGainSliderValue = std::make_unique <AudioProcessorValueTreeState::SliderAttachment>(audioProcessor.parameters, LSFGain_ID, lowGainSlider);
    lmFreqSilderValue = std::make_unique <AudioProcessorValueTreeState::SliderAttachment>(audioProcessor.parameters, PEQ1F_ID, lmFreqSilder);
    lmGainSliderValue = std::make_unique <AudioProcessorValueTreeState::SliderAttachment>(audioProcessor.parameters, PEQ1Gain_ID, lmGainSlider);
    hmFreqSliderValue = std::make_unique <AudioProcessorValueTreeState::SliderAttachment>(audioProcessor.parameters, PEQ2F_ID, hmFreqSlider);
    hmGainSliderValue = std::make_unique <AudioProcessorValueTreeState::SliderAttachment>(audioProcessor.parameters, PEQ2Gain_ID, hmGainSlider);
    highFreqSliderValue = std::make_unique <AudioProcessorValueTreeState::SliderAttachment>(audioProcessor.parameters, HSF_ID, highFreqSlider);
    highGainSliderValue = std::make_unique <AudioProcessorValueTreeState::SliderAttachment>(audioProcessor.parameters, HSFGain_ID, highGainSlider);
    ...
    attackSliderValue = std::make_unique <AudioProcessorValueTreeState::SliderAttachment>(audioProcessor.parameters, ATTACK_ID, attackSlider);
    ...
    osButtonValue = std::make_unique <AudioProcessorValueTreeState::ButtonAttachment>(audioProcessor.parameters, OS_ID, osButton);
    x2ButtonValue = std::make_unique <AudioProcessorValueTreeState::ButtonAttachment>(audioProcessor.parameters, X2_ID, x2Button);
    sustainButtonValue = std::make_unique <AudioProcessorValueTreeState::ButtonAttachment>(audioProcessor.parameters, INVERT_ID, sustainButton);
    ...
    uiSizeSlider.setRange(200, 1200, 1);
    uiSizeSlider.addListener(this);

    addAndMakeVisible(&amountText);
    amountSlider.setLookAndFeel(&rotaryLAF);
    addAndMakeVisible(&amountSlider);
    amountSlider.setRange(0.0f, 5.0f, 0.01f);
    amountSlider.setDoubleClickReturnValue(true, 0.0f);
    amountSlider.setSliderStyle(Slider::SliderStyle::Rotary);
    amountSlider.setTextBoxStyle(Slider::NoTextBox, false, 0, 0);
    defaultSliderBehaviour(amountSlider);


    addAndMakeVisible(&lowGainSlider);
    lowGainSlider.setRange(-24.f, 24.0f, 0.01f);
    lowGainSlider.setDoubleClickReturnValue(true, 0.0f);
    lowGainSlider.setSliderStyle(Slider::SliderStyle::LinearBarVertical);
    lowGainSlider.setTextValueSuffix(" dB");
    lowGainSlider.setColour(Slider::trackColourId, Colour(165, 71, 7).withAlpha(0.3f));
    defaultSliderBehaviour(lowGainSlider);
   
    addAndMakeVisible(&lmGainSlider);
    lmGainSlider.setRange(-24.f, 24.0f, 0.01f);
    lmGainSlider.setDoubleClickReturnValue(true, 0.0f);
    lmGainSlider.setSliderStyle(Slider::SliderStyle::LinearBarVertical);
    lmGainSlider.setTextValueSuffix(" dB");
    lmGainSlider.setColour(Slider::trackColourId, Colour(165, 71, 7).withAlpha(0.5f));
    defaultSliderBehaviour(lmGainSlider);

    addAndMakeVisible(&hmGainSlider);
    hmGainSlider.setRange(-24.f, 24.0f, 0.01f);
    hmGainSlider.setDoubleClickReturnValue(true, 0.0f);
    hmGainSlider.setSliderStyle(Slider::SliderStyle::LinearBarVertical);
    hmGainSlider.setTextValueSuffix(" dB");
    hmGainSlider.setColour(Slider::trackColourId, Colour(165, 71, 7).withAlpha(0.8f));
    defaultSliderBehaviour(hmGainSlider);

    addAndMakeVisible(&highGainSlider);
    highGainSlider.setRange(-24.f, 24.0f, 0.01f);
    highGainSlider.setDoubleClickReturnValue(true, 0.0f);
    highGainSlider.setSliderStyle(Slider::SliderStyle::LinearBarVertical);
    highGainSlider.setTextValueSuffix(" dB");
    highGainSlider.setColour(Slider::trackColourId, Colour(165, 71, 7));
    defaultSliderBehaviour(highGainSlider);


    addAndMakeVisible(&lowFreqSlider);
    lowFreqSlider.setRange(20, 400, 1);
    lowFreqSlider.setDoubleClickReturnValue(true, 50);
    lowFreqSlider.setSliderStyle(Slider::SliderStyle::LinearBar);
    lowFreqSlider.setTextValueSuffix(" Hz");
    lowFreqSlider.setColour(Slider::trackColourId, Colour(165, 71, 7).withAlpha(0.3f));
    defaultSliderBehaviour(lowFreqSlider);

    addAndMakeVisible(&lmFreqSilder);
    lmFreqSilder.setRange(20, 1500, 1);
    lmFreqSilder.setDoubleClickReturnValue(true, 150);
    lmFreqSilder.setSliderStyle(Slider::SliderStyle::LinearBar);
    lmFreqSilder.setTextValueSuffix(" Hz");
    lmFreqSilder.setColour(Slider::trackColourId, Colour(165, 71, 7).withAlpha(0.5f));
    defaultSliderBehaviour(lmFreqSilder);

    addAndMakeVisible(&hmFreqSlider);
    hmFreqSlider.setRange(650, 10000, 1);
    hmFreqSlider.setDoubleClickReturnValue(true, 4000);
    hmFreqSlider.setSliderStyle(Slider::SliderStyle::LinearBar);
    hmFreqSlider.setTextValueSuffix(" Hz");
    hmFreqSlider.setColour(Slider::trackColourId, Colour(165, 71, 7).withAlpha(0.8f));
    defaultSliderBehaviour(hmFreqSlider);

    addAndMakeVisible(&highFreqSlider);
    highFreqSlider.setRange(1500, 20000, 1);
    highFreqSlider.setDoubleClickReturnValue(true, 8000);
    highFreqSlider.setSliderStyle(Slider::SliderStyle::LinearBar);
    highFreqSlider.setTextValueSuffix(" Hz");
    highFreqSlider.setColour(Slider::trackColourId, Colour(165, 71, 7));
    defaultSliderBehaviour(highFreqSlider);

    addAndMakeVisible(&outputSlider);
    outputSlider.setRange(-24.0f, 12.0f, 0.01f);
    outputSlider.setDoubleClickReturnValue(true, 0.0f);
    outputSlider.setSliderStyle(Slider::SliderStyle::LinearBar);
    outputSlider.setTextValueSuffix(" dB");
    outputSlider.setColour(Slider::trackColourId, Colour(7, 112, 165));
    defaultSliderBehaviour(outputSlider);

    addAndMakeVisible(&attackSlider);
    attackSlider.setRange(0, 150, 0);
    attackSlider.setDoubleClickReturnValue(true, 20);
    ...
    defaultSliderBehaviour(attackSlider);

    addAndMakeVisible(&releaseSlider);
    releaseSlider.setRange(5, 1000, 0);
    ...
    dryWetSlider.setSliderStyle(Slider::SliderStyle::LinearBar);
    dryWetSlider.setTextValueSuffix("%");
    dryWetSlider.setColour(Slider::trackColourId, Colour(7, 112, 165));
    defaultSliderBehaviour(dryWetSlider);
   
    addAndMakeVisible(&clipButton);
    clipButton.addListener(this);
    clipButton.setLookAndFeel(&buttonLAF);
    clipButton.setColour(ToggleButton::tickColourId, Colour(7, 165, 18));

    addAndMakeVisible(&osButton);
    osButton.addListener(this);
    osButton.setLookAndFeel(&buttonLAF);
    osButton.setColour(ToggleButton::tickColourId, Colour(7, 165, 18));

    addAndMakeVisible(&x2Button);
    x2Button.addListener(this);
    x2Button.setLookAndFeel(&buttonLAF);
    x2Button.setColour(ToggleButton::tickColourId, Colour(7, 165, 18));

    addAndMakeVisible(&sustainButton);
    sustainButton.addListener(this);
    sustainButton.setLookAndFeel(&buttonLAF);
    sustainButton.setColour(ToggleButton::tickColourId, Colour(7, 165, 18));

    startTimerHz(30);
}

SpikeQAudioProcessorEditor::~SpikeQAudioProcessorEditor()
{
    rotaryLAF;
    buttonLAF;
}
...
void SpikeQAudioProcessorEditor::defaultSliderBehaviour(Slider& slider)
{
...
//==============================================================================
void SpikeQAudioProcessorEditor::paint (juce::Graphics& g)
{
    LookAndFeel::getDefaultLookAndFeel().setDefaultSansSerifTypeface(customTypeface);
    ...
    float square = area.getHeight() / 65.f;
    ...
    {//draw title
        ...
        int x = (area.getWidth() / 2.f) - (15 * square), y = square, width = 30 * square, height = 5 * square;
        g.setColour(Colours::whitesmoke);
        g.setFont(LWSFont);
        g.setFont(height);
        g.drawText("SpikeQ", x, y, width, height, Justification::centred);
    }

    {// help button
        help->setBounds(windowWidth - (square * 4.f), square * 2.f, 3 * square, 3.5 * square);
    }
    ...
    {//draw version number
        ...
        g.setFont(LWSFont);
        g.setFont(2 * square);
        g.drawText(JucePlugin_VersionString, windowWidth - (square * 12), square * 2.f, square * 8, square * 3.5, Justification::centred);
    }
    ...
    {//draw param back rectangles
        auto rLeft = Rectangle<float>(lowGainSlider.getX() - sideMargin * 2, lowGainSlider.getY() - (2 * sideMargin), highGainSlider.getRight() - lowGainSlider.getX() + 4 * sideMargin, lowFreqSlider.getBottom() - lowGainSlider.getY() + 3 * sideMargin);
        g.setColour(Colour(7, 112, 165));
        g.setOpacity(0.25f);
        g.fillRoundedRectangle(rLeft, 5);

        auto rRight = Rectangle<float>(attackSlider.getX() - sideMargin * 2, attackSlider.getY() - (2 * sideMargin), attackSlider.getRight() - attackSlider.getX() + 4 * sideMargin, dryWetSlider.getBottom() - attackSlider.getY() + 3 * sideMargin);
        g.setColour(Colour(7, 165, 18));
        g.setOpacity(0.25f);
        g.fillRoundedRectangle(rRight, 5);

        auto rCenter = Rectangle<float>(rLeft.getRight(), rLeft.getY(), rRight.getX() - rLeft.getRight(), rLeft.getHeight());
        g.setColour(Colours::darkgrey);
        g.setOpacity(0.15f);
        g.fillRoundedRectangle(rCenter, 5);
        
    }

    paramTextStyle(g, "Amount", amountSlider.getX(), amountSlider.getBottom() * 0.8 , amountSlider.getWidth(), 2 * square, false, Justification::centredBottom, Colour::fromRGBA(171, 171, 171, 0.75));
    paramTextStyle(g, "x2", x2Button.getX() - x2Button.getWidth(), x2Button.getY() - (6 * square), x2Button.getWidth() * 3, 2 * square, false, Justification::centredBottom, Colour::fromRGBA(171, 171, 171, 0.75));
    paramTextStyle(g, "Clip", clipButton.getX(), clipButton.getY() - (6 * square), clipButton.getWidth(), 2 * square, false, Justification::centredBottom, Colour::fromRGBA(171, 171, 171, 0.75));
    paramTextStyle(g, "O.S.", osButton.getX(), osButton.getY() - (6 * square), osButton.getWidth(), 2 * square, false, Justification::centredBottom, Colour::fromRGBA(171, 171, 171, 0.75));
    paramTextStyle(g, "Sustain", sustainButton.getX() - sustainButton.getWidth() * 0.5, sustainButton.getY() - (6 * square), sustainButton.getWidth() * 2, 2 * square, false, Justification::centredBottom, Colour::fromRGBA(171, 171, 171, 0.75));

    paramTextStyle(g, "Attack", attackSlider.getX(), attackSlider.getY() - (7 * square), attackSlider.getWidth(), 2 * square, false, Justification::centredBottom, Colour::fromRGBA(171, 171, 171, 0.75));
    paramTextStyle(g, "Release", releaseSlider.getX(), releaseSlider.getY() - (7 * square), releaseSlider.getWidth(), 2 * square, false, Justification::centredBottom, Colour::fromRGBA(171, 171, 171, 0.75));
    paramTextStyle(g, "Output (Pre-Clipper)", outputSlider.getX(), outputSlider.getY() - (7 * square), outputSlider.getWidth(), 2 * square, false, Justification::centredBottom, Colour::fromRGBA(171, 171, 171, 0.75));
    paramTextStyle(g, "Dry/Wet", dryWetSlider.getX(), dryWetSlider.getY() - (7 * square), dryWetSlider.getWidth(), 2 * square, false, Justification::centredBottom, Colour::fromRGBA(171, 171, 171, 0.75));
    paramTextStyle(g, "Low", lowGainSlider.getX(), lowGainSlider.getY() - (7 * square), lowGainSlider.getWidth(), 2 * square, false, Justification::centredBottom, Colour::fromRGBA(171, 171, 171, 0.75));
    paramTextStyle(g, "Lo-Mid", lmGainSlider.getX(), lmGainSlider.getY() - (7 * square), lmGainSlider.getWidth(), 2 * square, false, Justification::centredBottom, Colour::fromRGBA(171, 171, 171, 0.75));
    paramTextStyle(g, "Hi-Mid", hmGainSlider.getX(), hmGainSlider.getY() - (7 * square), hmGainSlider.getWidth(), 2 * square, false, Justification::centredBottom, Colour::fromRGBA(171, 171, 171, 0.75));
    paramTextStyle(g, "High", highGainSlider.getX(), highGainSlider.getY() - (7 * square), highGainSlider.getWidth(), 2 * square, false, Justification::centredBottom, Colour::fromRGBA(171, 171, 171, 0.75));

    {//Increase this
        paramTextStyle(g, "Increase this", amountSlider.getX() + amountSlider.getWidth() * 0.25, lowGainSlider.getY() - (7 * square), amountSlider.getWidth(), 2 * square, false, Justification::centredBottom, Colour::fromRGBA(171, 171, 171, 0.75));
        auto l = Line<float>(amountSlider.getX() + amountSlider.getWidth() * 0.75, lowGainSlider.getY() - square, amountSlider.getX() + amountSlider.getWidth() * 0.75, amountSlider.getY() + sliderHeight * 0.4);
        g.drawArrow(l, 1, 6, 8);
    }

    {//for these to work
        paramTextStyle(g, "for these to work", highGainSlider.getRight(), highGainSlider.getY() - sideMargin, amountSlider.getWidth(), 2 * square, false, Justification::centredBottom, Colour::fromRGBA(171, 171, 171, 0.75));
        auto l = Line<float>(highGainSlider.getRight() + amountSlider.getWidth() * 0.2, lowGainSlider.getY() + (3 * square), highGainSlider.getRight(), lowGainSlider.getY() + (3 * square));
       g.drawArrow(l, 1, 6, 8);
    }
}

void SpikeQAudioProcessorEditor::resized()
{
    LookAndFeel::getDefaultLookAndFeel().setDefaultSansSerifTypeface(customTypeface);
    ...
    float square = area.getHeight() / 65.f;
    auto sliderHeight = 5 * square;
    auto sliderSpacing = 4 * square;
    auto sideMargin = 4 * square;
    auto sliderWidth = ((windowWidth - (2 * sideMargin)) / 3);

    lowGainSlider.setBounds(sideMargin * 2.25, sliderHeight * 2 + sideMargin, sliderHeight * 2, sliderWidth * 0.75);
    lmGainSlider.setBounds(lowGainSlider.getRight() + sliderSpacing * 2, lowGainSlider.getY(), sliderHeight * 2, sliderWidth * 0.75);
    hmGainSlider.setBounds(lmGainSlider.getRight() + sliderSpacing * 2, lmGainSlider.getY(), sliderHeight * 2, sliderWidth * 0.75);
    highGainSlider.setBounds(hmGainSlider.getRight() + sliderSpacing * 2, hmGainSlider.getY(), sliderHeight * 2, sliderWidth * 0.75);

    lowFreqSlider.setBounds(sideMargin * 1.75, lowGainSlider.getBottom() + sliderSpacing, (sideMargin) + (sliderHeight * 2), sliderHeight * 0.75);
    lmFreqSilder.setBounds(lmGainSlider.getX() - (sideMargin * 0.5), lowFreqSlider.getY(), (sideMargin) + (sliderHeight * 2), sliderHeight * 0.75);
    hmFreqSlider.setBounds(hmGainSlider.getX() - (sideMargin * 0.5), lowFreqSlider.getY(), (sideMargin) + (sliderHeight * 2), sliderHeight * 0.75);
    highFreqSlider.setBounds(highGainSlider.getX() - (sideMargin * 0.5), lowFreqSlider.getY(), (sideMargin) + (sliderHeight * 2), sliderHeight * 0.75);

    amountSlider.setBounds(highGainSlider.getRight() + sliderSpacing * 2, highGainSlider.getY() + sliderWidth * 0.125, sliderWidth * 0.5, sliderWidth * 0.5);
    
    {//set bounds for rotary text label
        auto w = 8 * square;
        auto h = 4 * square;
        auto sliderBounds = amountSlider.getBounds();

        amountText.setSize(w, h);
        Point<int> textBounds = sliderBounds.getCentre();
        Point<int> addPoint(square, 0);
        textBounds += addPoint;
        amountText.setCentrePosition(textBounds);

    }

    attackSlider.setBounds(amountSlider.getRight() + sideMargin * 2, lowGainSlider.getY(), sliderWidth * 0.75, sliderHeight * 1.25);
    releaseSlider.setBounds(attackSlider.getX(), attackSlider.getBottom() + sliderSpacing * 1.75, sliderWidth * 0.75, sliderHeight * 1.25);
    outputSlider.setBounds(attackSlider.getX(), releaseSlider.getBottom() + sliderSpacing * 1.75, sliderWidth * 0.75, sliderHeight * 1.25);
    dryWetSlider.setBounds(outputSlider.getX(), outputSlider.getBottom() + sliderSpacing * 1.75, sliderWidth * 0.75, sliderHeight * 1.25);

    x2Button.setBounds(amountSlider.getX() + (amountSlider.getWidth() * 0.5) - (sliderHeight * 1.4), amountSlider.getBottom() + (sliderSpacing * 0.5), sliderHeight * 0.75, sliderHeight * 0.75);
    clipButton.setBounds(x2Button.getX(), highFreqSlider.getY(), sliderHeight * 0.75, sliderHeight * 0.75);
    osButton.setBounds(x2Button.getX() + sliderHeight * 2, highFreqSlider.getY(), sliderHeight * 0.75, sliderHeight * 0.75);
    sustainButton.setBounds(x2Button.getX() + sliderHeight * 2, amountSlider.getBottom() + (sliderSpacing * 0.5), sliderHeight * 0.75, sliderHeight * 0.75);
}

void SpikeQAudioProcessorEditor::paintOverChildren(juce::Graphics& g)
{
    LookAndFeel::getDefaultLookAndFeel().setDefaultSansSerifTypeface(customTypeface);
    LWSFont = g.getCurrentFont();
    //keepAspectRatio();
    ...
    amountText.setText(amountSlider.getTextFromValue(amountSlider.getValue()), sendNotification);
}

void SpikeQAudioProcessorEditor::sliderValueChanged(Slider* sliderThatHasChanged)
{
    if (sliderThatHasChanged == &lowFreqSlider)
    {
        audioProcessor.mLsf = lowFreqSlider.getValue();
    }
    else if (sliderThatHasChanged == &lmFreqSilder)
    {
        audioProcessor.mPeq1F = lmFreqSilder.getValue();
    }
    else if (sliderThatHasChanged == &hmFreqSlider)
    {
        audioProcessor.mPeq2F = hmFreqSlider.getValue();
    }
    else if (sliderThatHasChanged == &highFreqSlider)
    {
        audioProcessor.mHsf = highFreqSlider.getValue();
    }
    else if (sliderThatHasChanged == &lowGainSlider)
    {
        audioProcessor.mLsfG = lowGainSlider.getValue();
    }
    else if (sliderThatHasChanged == &lmGainSlider)
    {
        audioProcessor.mPeq1G = lowGainSlider.getValue();
    }
    else if (sliderThatHasChanged == &hmGainSlider)
    {
        audioProcessor.mPeq2G = hmGainSlider.getValue();
    }
    else if (sliderThatHasChanged == &highGainSlider)
    {
        audioProcessor.mHsfG = highGainSlider.getValue();
    }
    else if (sliderThatHasChanged == &amountSlider)
    {
        audioProcessor.mAmount = amountSlider.getValue();
        amountText.setText(amountSlider.getTextFromValue(amountSlider.getValue()), dontSendNotification);
    }
    else if (sliderThatHasChanged == &attackSlider)
    {
        audioProcessor.mAttack = attackSlider.getValue();
    }
    else if (sliderThatHasChanged == &releaseSlider)
    {
        audioProcessor.mRelease = releaseSlider.getValue();
    }
    else if (sliderThatHasChanged == &outputSlider)
    {
        audioProcessor.mOutput = outputSlider.getValue();
    }
    else if (sliderThatHasChanged == &dryWetSlider)
    {
        audioProcessor.mDryWet = dryWetSlider.getValue();
    }
}

void SpikeQAudioProcessorEditor::buttonClicked(Button* buttonThatHasChanged)
{
    if (buttonThatHasChanged == &clipButton)
    {
        audioProcessor.mClip = clipButton.getToggleState();
    }
    else if (buttonThatHasChanged == &x2Button)
    {
        audioProcessor.mScale = x2Button.getToggleState();
    }
    else if (buttonThatHasChanged == &osButton)
    {
        audioProcessor.mOs = osButton.getToggleState();
    }
}
void SpikeQAudioProcessorEditor::timerCallback()
{


}

void SpikeQAudioProcessorEditor::newButtonStyle(Colour textColour, Colour tickColour, Colour disableColour)
{
...
void SpikeQAudioProcessorEditor::newSliderStyle(Colour textColour, float trackTransp, Slider::TextEntryBoxPosition textBoxStyle, bool readonly, int width, int height)
{
    /*
...
void SpikeQAudioProcessorEditor::paramTextStyle(Graphics& g, String name, float x, float y, float width, float fontHeight, bool drawBox, Justification justification, Colour textColour)
{
    LookAndFeel::getDefaultLookAndFeel().setDefaultSansSerifTypeface(customTypeface);
...
const char* SpikeQAudioProcessorEditor::logoSmall_png = (const char*)resource_NewComponent2_logoSmall_png;
const int SpikeQAudioProcessorEditor::logoSmall_pngSize = 19731;
