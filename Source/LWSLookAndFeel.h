...
#define greenColour Colour::fromRGBA(7, 165, 18, 100);
...
public:
    ...
    public:
...

        {
            ...
            g.drawEllipse(bounds.reduced(2), 1);
            g.drawHorizontalLine(bounds.getCentreY() * 1.65, bounds.getWidth() * 0.141, bounds.getWidth() * 0.859);
        }
    ...
    public:
...

        {
            ...
            auto outline = Colours::whitesmoke;
            auto attackColor = Colour(165, 71, 7);
            auto sustainColor = Colour(7, 112, 165);
