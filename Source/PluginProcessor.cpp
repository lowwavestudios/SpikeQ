...
AudioProcessorValueTreeState::ParameterLayout SpikeQAudioProcessor::createParameterLayout()
{
    ...
    auto attackParam = std::make_unique <AudioParameterFloat>(ATTACK_ID, ATTACK_NAME, 1.0f, 150.0f, 20.0f);
    ...
    auto lsfGainParam = std::make_unique <AudioParameterFloat>(LSFGain_ID, LSFGain_NAME, 0.0f, 24.f, 0.f);
    auto hsfGainParam = std::make_unique <AudioParameterFloat>(HSFGain_ID, HSFGain_NAME, 0.0f, 24.f, 0.f);
    auto peq1GainParam = std::make_unique <AudioParameterFloat>(PEQ1Gain_ID, PEQ1Gain_NAME, 0.0f, 24.f, 0.f);
    auto peq2GainParam = std::make_unique <AudioParameterFloat>(PEQ2Gain_ID, PEQ2Gain_NAME, 0.0f, 24.f, 0.f);
...
void SpikeQAudioProcessor::setParams()
{
    ...
    mEnvelopeEQ.setParams(mRelease, mAttack, mAmount);
}
//==============================================================================
